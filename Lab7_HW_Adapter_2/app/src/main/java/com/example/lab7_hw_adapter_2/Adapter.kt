package com.example.lab7_hw_adapter_2
...
class Adapter(context: Context, data: ArrayList<Item>, private val layout: Int) : ArrayAdapter<Item>(context, layout, data) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        tv_msg.text = if (layout == R.layout.activity_adapter2)
            item.name
        else
